public class resources {
	...
	resources()
	{
		instruction = "<html><font size=\"4\">1. Ensure the executable jar file is placed in the same folder with the \"settings.ini\" (settings.ini is optional) and the \"voice\" folder.</font></html>\n"
				    + "<html><font size=\"4\">2. \"From\" should be less than \"To\" and they both should be between Min and Max.</font></html>\n"
					+ "<html><font size=\"4\">3. \"Reset Program\" won't overwrite your saved settings, only \"Save Progress\" will.</font></html>\n"
				    + "<html><font size=\"4\">4. In the \"View Syllable Chart\" window, you can click on each syllable to hear its pronounciation.</font></html>\n";
		about = "<html><font size=\"4\">\"Japanese Syllable Trainer\" is designed by James Sullivan.</font></html>";
	}
	//End of Constructor
}
